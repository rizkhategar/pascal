...
<head>
    ...
    <style>
        :root{--primary:#072b57;--yellow:#f7b500;--white:#fff;--light:#f8fafc;--text:#111827;--muted:#64748b;--border:#e5e7eb;--green:#14532d;--soft-black:rgba(17,24,39,.66)}
        *{box-sizing:border-box}body{margin:0;font-family:Arial,Helvetica,sans-serif;background:var(--light);color:var(--text)}.container{width:min(100% - 40px,1180px);margin:0 auto}.news-hero{background:linear-gradient(135deg,#052044,#083b73);color:#fff;padding:72px 0;position:relative;overflow:hidden}.news-hero:after{content:"";position:absolute;right:-70px;top:-80px;width:280px;height:280px;background:rgba(247,181,0,.14);border-radius:50%;filter:blur(3px)}.news-hero .container{position:relative;z-index:1}.hero-kicker{display:inline-flex;align-items:center;gap:9px;color:var(--yellow);font-weight:900;font-size:13px;text-transform:uppercase;letter-spacing:1.4px;margin-bottom:12px}.page-title{font-size:clamp(32px,5vw,52px);line-height:1.1;margin:0 0 16px;font-weight:900}.page-desc{max-width:720px;margin:0;color:rgba(255,255,255,.82);font-size:17px;line-height:1.7}.news-section{padding:52px 0 80px}.news-toolbar{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:24px;flex-wrap:wrap}.filter-bar{display:flex;gap:8px;flex-wrap:wrap;padding:12px;background:#fff;border:1px solid rgba(7,43,87,.1);border-radius:14px;box-shadow:0 10px 28px rgba(15,23,42,.05)}.filter-btn{display:inline-flex;align-items:center;gap:7px;border:1px solid rgba(7,43,87,.16);background:#f8fafc;color:var(--primary);font-weight:900;font-size:12px;border-radius:8px;padding:8px 13px;cursor:pointer;white-space:nowrap;transition:.2s ease}.filter-btn i{color:var(--yellow)}.filter-btn.active,.filter-btn:hover{background:var(--yellow);border-color:var(--yellow);color:#fff;box-shadow:0 8px 18px rgba(247,181,0,.25)}.filter-btn.active i,.filter-btn:hover i{color:#fff}.news-search-wrap{display:flex;align-items:center;gap:8px}.search-box{height:46px;min-width:280px;border:1px solid var(--border);border-radius:11px;background:#fff;padding:0 15px;outline:none;font-weight:800;color:var(--primary);box-shadow:0 10px 24px rgba(15,23,42,.04)}.search-icon-btn{width:46px;height:46px;border:0;border-radius:11px;background:var(--primary);color:#fff;font-size:17px;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 12px 24px rgba(7,43,87,.18);transition:.2s ease}.search-icon-btn:hover{background:var(--yellow);transform:translateY(-2px)}.news-page-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:22px}.news-page-card{background:#fff;border:1px solid rgba(7,43,87,.1);border-radius:18px;overflow:hidden;box-shadow:0 16px 38px rgba(15,23,42,.08);transition:.24s ease;text-decoration:none;color:inherit;display:flex;flex-direction:column;min-height:100%}.news-page-card:hover{transform:translateY(-4px);box-shadow:0 24px 48px rgba(15,23,42,.12)}.news-page-thumb{width:100%;aspect-ratio:16/9;background:#eef2f7;overflow:hidden;position:relative;flex-shrink:0}.news-page-thumb img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;transition:.35s ease}.news-page-card:hover .news-page-thumb img{transform:scale(1.045)}.news-page-body{padding:18px;display:flex;flex-direction:column;flex:1}.news-page-category{display:inline-flex;align-items:center;gap:7px;color:var(--green);font-weight:900;font-size:12px}.news-page-category i{color:var(--yellow)}.news-page-title{font-size:18px;line-height:1.38;color:var(--primary);font-weight:900;margin:11px 0;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}.news-page-excerpt{color:var(--muted);font-size:14px;line-height:1.65;margin:0 0 14px;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;flex:1}.news-page-date{display:inline-flex;align-items:center;gap:7px;color:var(--soft-black);font-weight:900;font-size:12px}.news-page-date i{color:rgba(17,24,39,.48)}.pagination{margin-top:32px;display:flex;align-items:center;justify-content:center;gap:8px;flex-wrap:wrap}.page-btn{height:38px;min-width:38px;border:1px solid rgba(7,43,87,.16);border-radius:8px;background:#fff;color:var(--primary);font-weight:900;cursor:pointer;padding:0 12px}.page-btn.active,.page-btn:hover{background:var(--yellow);border-color:var(--yellow);color:#fff}.page-btn[disabled]{opacity:.45;cursor:not-allowed;background:#f1f5f9;color:#94a3b8}.page-dots{font-weight:900;color:#94a3b8}.page-jump{display:flex;align-items:center;gap:7px;margin-left:6px;border-left:1px solid rgba(7,43,87,.12);padding-left:12px}.page-jump input{width:72px;height:38px;border:1px solid rgba(7,43,87,.16);border-radius:8px;padding:0 10px;color:var(--primary);font-weight:900;outline:none}.page-jump button{height:38px;border:0;border-radius:8px;background:var(--primary);color:#fff;font-size:12px;font-weight:900;padding:0 13px;cursor:pointer}.page-jump button:hover{background:var(--yellow)}.loading,.empty{grid-column:1/-1;background:#fff;border:1px solid var(--border);border-radius:16px;padding:32px;text-align:center;color:var(--muted);font-weight:800}.loader{width:42px;height:42px;border:4px solid #e5e7eb;border-top-color:var(--yellow);border-radius:50%;animation:spin .8s linear infinite;margin:0 auto}@keyframes spin{to{transform:rotate(360deg)}}@media(max-width:992px){.news-page-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:640px){.container{width:min(100% - 28px,1180px)}.news-hero{padding:52px 0}.news-section{padding:34px 0 60px}.news-page-grid{grid-template-columns:1fr}.news-search-wrap{width:100%}.search-box{width:100%;min-width:0}.news-toolbar{align-items:stretch}.filter-bar{overflow-x:auto;flex-wrap:nowrap;padding-bottom:12px;scrollbar-width:none}.filter-bar::-webkit-scrollbar{display:none}.filter-btn{flex:0 0 auto}.pagination{justify-content:flex-start;overflow-x:auto;flex-wrap:nowrap;padding-bottom:6px;scrollbar-width:none}.pagination::-webkit-scrollbar{display:none}.page-jump{flex:0 0 auto}.page-jump input{width:58px}}
    </style>
</head>
<body>
    ...
    <script>
        (function(){
            ...
            const grid=document.getElementById('newsGrid'),filters=document.getElementById('newsFilters'),pagination=document.getElementById('newsPagination'),search=document.getElementById('newsSearch'),searchButton=document.getElementById('newsSearchButton');
            ...
            function buildUrl(page,perPage){const p=new URLSearchParams({paginate:String(perPage),page:String(page)});if(state.category.id!=='all'){p.set('category_id',state.category.id);p.set('category',state.category.slug||state.category.id)}return API.news+'?'+p.toString()}
            function render(items){if(!items.length){grid.innerHTML='<div class="empty">Belum ada berita yang sesuai.</div>';return}grid.innerHTML=items.map(n=>'<a class="news-page-card" href="/berita/'+encodeURIComponent(n.slug)+'"><div class="news-page-thumb">'+(n.image?'<img src="'+esc(img(n.image))+'" alt="'+esc(n.title)+'">':'')+'</div><div class="news-page-body"><div class="news-page-category"><i class="fas fa-tag"></i>'+esc(n.categoryName)+'</div><h2 class="news-page-title">'+esc(n.title)+'</h2><p class="news-page-excerpt">'+esc(strip(n.excerpt))+'</p><div class="news-page-date"><i class="fas fa-calendar-alt"></i>'+esc(date(n.date))+'</div></div></a>').join('')}
            ...
            function searchKey(){return state.category.id+'|'+(state.category.slug||'all')}
            async function fetchAllNews(){const key=searchKey();if(cache.key===key&&cache.items.length)return cache.items;let page=1,last=1,items=[];do{const payload=await get(buildUrl(page,100));items=items.concat(arr(payload).map(normalize));last=Number(payload?.meta?.last_page||1);page++}while(page<=last);cache.key=key;cache.items=items;return items}
            function matchesSearch(item,q){const haystack=[item.title,strip(item.excerpt),item.categoryName,date(item.date)].join(' ').toLowerCase();return haystack.includes(q)}
            async function load(){grid.innerHTML='<div class="loading"><div class="loader"></div></div>';try{const q=state.q.trim().toLowerCase();if(q){const allItems=await fetchAllNews();const filtered=allItems.filter(item=>matchesSearch(item,q));state.lastPage=Math.max(1,Math.ceil(filtered.length/PAGE_SIZE));state.page=Math.min(Math.max(1,state.page),state.lastPage);const start=(state.page-1)*PAGE_SIZE;render(filtered.slice(start,start+PAGE_SIZE));renderPages();return}const p=await get(buildUrl(state.page,PAGE_SIZE));state.lastPage=Number(p?.meta?.last_page||1);state.page=Number(p?.meta?.current_page||state.page);render(arr(p).map(normalize));renderPages()}catch(e){grid.innerHTML='<div class="empty">Berita belum dapat dimuat.</div>'}}
            async function loadFilters(){try{const p=await get(API.category);filters.innerHTML='<button class="filter-btn active" data-id="all" data-slug="all"><i class="fas fa-tag"></i>Semua</button>'+arr(p).map(c=>'<button class="filter-btn" data-id="'+esc(c.id)+'" data-slug="'+esc(c.slug||'')+'"><i class="fas fa-tag"></i>'+esc(c.name)+'</button>').join('');filters.querySelectorAll('.filter-btn').forEach(btn=>btn.onclick=()=>{filters.querySelectorAll('.filter-btn').forEach(b=>b.classList.remove('active'));btn.classList.add('active');state.category={id:btn.dataset.id,slug:btn.dataset.slug};state.page=1;cache.key='';cache.items=[];load()})}catch(e){}}
            search.addEventListener('input',()=>{clearTimeout(searchTimer);state.q=search.value;state.page=1;searchTimer=setTimeout(load,350)});
            searchButton?.addEventListener('click',()=>{state.q=search.value;state.page=1;search.focus();load()});
            loadFilters();load();
        })();
    </script>
</body>
