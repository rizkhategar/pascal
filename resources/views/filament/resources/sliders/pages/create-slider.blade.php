<x-filament-panels::page>
    ...
    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        @csrf
        ...
        <div class="custom-form-card">
            <div class="custom-form-grid">
                ...
                <div class="custom-field">
                    ...
                    <p class="custom-help">Use JPG, PNG, or WEBP. Maximum file size: 8 MB.</p>
                </div>
        ...
        <div class="custom-actions">
            <button type="submit" class="custom-btn-primary">Save Slider</button>
