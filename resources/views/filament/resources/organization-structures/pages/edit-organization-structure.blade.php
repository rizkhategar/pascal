<x-filament-panels::page>
    <style>
        ...
        .custom-field input[type="text"], .custom-field input[type="file"] { display: block; width: 100%; min-height: 42px; border: 1px solid rgba(255,255,255,.14); background: #111114; color: #f4f4f5; border-radius: 10px; padding: 10px 12px; outline: none; }
    ...
    <form action="{{ route('admin.organization-structures.update', $this->record) }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        @csrf
        @method('PUT')
            ...
            <div class="custom-form-grid">
                ...
                <div class="custom-field">
                    ...
                    @if ($this->record->image_path)
                        <img src="{{ route('organization-structures.image', $this->record) }}?v={{ optional($this->record->updated_at)->timestamp }}" alt="{{ $this->record->title }}" class="custom-preview">
                    @else
                ...
                <div class="custom-field">
                    <label for="image">Replace Organization Structure Image</label>
                    <input type="file" id="image" name="image" accept="image/jpeg,image/png,image/webp">
                    <p class="custom-help">Leave empty if you do not want to replace the image. Maximum file size: 5 MB.</p>
                </div>
        ...
        <div class="custom-actions">
            ...
            <a href="{{ \App\Filament\Resources\OrganizationStructures\OrganizationStructureResource::getUrl('index') }}" class="custom-btn-secondary">Cancel</a>
        </div>
    </form>
</x-filament-panels::page>
