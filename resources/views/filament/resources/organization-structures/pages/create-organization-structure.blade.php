<x-filament-panels::page>
    ...
    <form action="{{ route('admin.organization-structures.store') }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        @csrf
        ...
        <div class="custom-form-card">
            <div class="custom-form-grid">
                <div class="custom-field">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', 'Organization Structure') }}" required>
                </div>

                <div class="custom-field">
                    <label for="image">Organization Structure Image</label>
                    <input type="file" id="image" name="image" accept="image/jpeg,image/png,image/webp" required>
                    <p class="custom-help">Use JPG, PNG, or WEBP. Maximum file size: 5 MB.</p>
                </div>
        ...
        <div class="custom-actions">
            <button type="submit" class="custom-btn-primary">Save Organization Structure</button>
