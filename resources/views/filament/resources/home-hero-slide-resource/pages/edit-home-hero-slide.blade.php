<x-filament-panels::page>
    ...
    <form action="{{ route('admin.home-hero-slides.update-custom', $this->record) }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        @csrf
        @method('PUT')
        ...
        <div class="custom-form-card">
            <div class="custom-form-grid">
                <div class="custom-field">
                    ...
                    <p class="custom-help">Teks ini akan tampil pada hero. Tombol Daftar Sekarang tetap statis.</p>
                </div>
                ...
                <div class="custom-field">
                    ...
                    <p class="custom-help">Kosongkan jika tidak ingin mengganti gambar. File JPG, PNG, atau WEBP. Maksimal 8 MB.</p>
                </div>
                ...
                <div class="custom-field">
                    ...
                    <p class="custom-help">Contoh: 3000 berarti gambar berganti setiap 3 detik.</p>
                </div>
        ...
        <div class="custom-actions">
            ...
            <a href="{{ \App\Filament\Resources\HomeHeroSlideResource::getUrl('index') }}" class="custom-btn-secondary">Batal</a>
        </div>
    </form>
</x-filament-panels::page>
