<x-filament-panels::page>
    <style>
        ...
        .custom-btn-secondary:hover { background: rgba(255, 255, 255, 0.06); }
    ...
    <form action="{{ route('admin.home-hero-slides.store-custom') }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        @csrf
        ...
        <div class="custom-form-card">
            <div class="custom-form-grid">
                <div class="custom-field">
                    ...
                    <p class="custom-help">Teks ini akan menggantikan judul hero. Tombol Daftar Sekarang tetap statis.</p>
                </div>
                ...
                <div class="custom-field">
                    ...
                    <p class="custom-help">Gunakan JPG, PNG, atau WEBP. Maksimal 8 MB.</p>
                </div>
        ...
        <div class="custom-actions">
            <button type="submit" class="custom-btn-primary">Simpan Hero Campus</button>
